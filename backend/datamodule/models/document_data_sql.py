...
INSERT INTO _document_datas (id, ocr_doc_type_prediction_str, ocr_predictions_str, ocr_full_text, ocr_extracted_data, layoutlm_full_text, layout_lm_data)
...
SET ocr_doc_type_prediction_str = %s, ocr_predictions_str = %s, ocr_full_text = %s, ocr_extracted_data = %s, layoutlm_full_text = %s, layout_lm_data = %s
WHERE id = %s
RETURNING *;
""" 
...
SELECT id, ocr_doc_type_prediction_str, ocr_predictions_str, ocr_full_text, ocr_extracted_data, layoutlm_full_text, layout_lm_data
